...
from algorithms.flax_sac import STAE_ActorBackbone, Actor
...
class LegacyActor(nn.Module):
    ...
    def get_action(self, x, key):
        ...
        return action_env, jnp.zeros((1, 1))
...
def main():
    ...
    # Use the massive 3km map with 600 obstacles exactly like the training loop
    env_params = env.default_params.replace(num_agents=num_agents, map_size=3000.0, num_obstacles=600, max_steps=2000)
    ...
    os.makedirs("logs_max", exist_ok=True)
    gif_path = "logs_max/swarm_simulation_max.gif"
