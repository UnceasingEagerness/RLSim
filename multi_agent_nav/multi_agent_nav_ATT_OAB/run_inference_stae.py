...
def main():
    ...
    # ── Load Model ────────────────────────────────────────────────────────────
    ckpt_dir = os.path.abspath("checkpoints_stae/sac_actor_final")
    ...
    console.print("[yellow]Rendering MP4/GIF Animation... (This may take a minute)[/yellow]")
    anim.save('logs_stae/swarm_simulation_stae.gif', writer='pillow', fps=30)
    console.print("[bold green]✔ Saved gorgeous swarm simulation to logs_stae/swarm_simulation_stae.gif[/bold green]")
    plt.close()
